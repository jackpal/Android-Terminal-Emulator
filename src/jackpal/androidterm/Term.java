...
public class Term extends Activity {
    ...
    public static final String EXTRA_WINDOW_ID = "jackpal.androidterm2.window_id";
    ...
    private TermSession createTermSession() {
        ...
        String iInitialCommand = getIntent().getStringExtra("jackpal.androidterm2.iInitialCommand");
