...
public class RemoteInterface extends Activity {
    private static final String ACTION_RUN_SCRIPT = "jackpal.chameleonterm.RUN_SCRIPT";

    static final String PRIVACT_OPEN_NEW_WINDOW = "jackpal.chameleonterm.private.OPEN_NEW_WINDOW";
    static final String PRIVACT_SWITCH_WINDOW = "jackpal.chameleonterm.private.SWITCH_WINDOW";

    private static final String EXTRA_WINDOW_HANDLE = "jackpal.chameleonterm.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "jackpal.chameleonterm.iInitialCommand";

    static final String PRIVEXTRA_TARGET_WINDOW = "jackpal.chameleonterm.private.target_window";
