...
package jackpal.chameleonterm.shortcuts;
...
import jackpal.chameleonterm.R;
import jackpal.chameleonterm.compat.AlertDialogCompat;
       ...
       extends    android.app.Activity
{
  ...
  private final String                 pkg_jackpal=                 "jackpal.chameleonterm";
  private       int                    ix=                          0;
  ...
  void makeShortcut()
  {
              ...
              new View.OnClickListener()
              {
                public void onClick(View p1)
                {
                  ...
                  File get= (lastPath==null)
                    ...
                    {
                      pickerIntent.setClass(getApplicationContext(), jackpal.chameleonterm.shortcuts.FSNavigator.class)
    ...
    final ImageView img=new ImageView(context);
                    img.setImageResource(jackpal.chameleonterm.R.drawable.ic_launcher);
    ...
    )
    {
      ...
      Intent wrapper= new Intent();
             ...
             else
             {
               ...
               , Intent.ShortcutIconResource.fromContext(context, jackpal.chameleonterm.R.drawable.ic_launcher)
               );
             }
