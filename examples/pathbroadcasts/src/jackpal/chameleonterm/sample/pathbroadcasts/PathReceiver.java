...
package jackpal.chameleonterm.sample.pathbroadcasts;
...
public class PathReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
         ...
         * jackpal.chameleonterm.permission.APPEND_TO_PATH
         * to receive this broadcast.
         */
        if (action.equals("jackpal.chameleonterm.broadcast.APPEND_TO_PATH")) {
        ...
        /**
         * You need to declare the permission
         * jackpal.chameleonterm.permission.PREPEND_TO_PATH
         * to receive this broadcast.
         *
         ...
         */
        if (action.equals("jackpal.chameleonterm.broadcast.PREPEND_TO_PATH")) {
