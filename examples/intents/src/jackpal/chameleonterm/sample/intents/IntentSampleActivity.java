package jackpal.chameleonterm.sample.intents;
...
public class IntentSampleActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        addClickListener(R.id.openNewWindow, new OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent =
                        new Intent("jackpal.chameleonterm.OPEN_NEW_WINDOW");
        ...
        addClickListener(R.id.runScript, new OnClickListener() {
            public void onClick(View v) {
                /* Intent for opening a new window and running the provided
                   ...
                   jackpal.chameleonterm.permission.RUN_SCRIPT in your manifest
                   to use */
                Intent intent =
                        new Intent("jackpal.chameleonterm.RUN_SCRIPT");
                intent.addCategory(Intent.CATEGORY_DEFAULT);
                String command = script.getText().toString();
                intent.putExtra("jackpal.chameleonterm.iInitialCommand", command);
                startActivity(intent);
            }});
        addClickListener(R.id.runScriptSaveWindow, new OnClickListener() {
            public void onClick(View v) {
                ...
                if (mHandle != null) {
                    ...
                    intent.putExtra("jackpal.chameleonterm.window_handle",
                            mHandle);
                }
    ...
    protected void onActivityResult(int request, int result, Intent data) {
        ...
        if (request == REQUEST_WINDOW_HANDLE && data != null) {
            mHandle = data.getStringExtra("jackpal.chameleonterm.window_handle");
